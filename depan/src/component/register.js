...
function Register(){
    ...
    return (
        ...
        <form action="">
            ...
            <input type="checkbox" name="checkbox" id="checkbox" value={hasAgreed} onChange={()=>setHasAgreed(!hasAgreed)}/>      
            <label htmlFor="checkbox">I Agree</label>
            </div>
            <div className="form-group">
            <button style={{color:'white'}} className="btn btn-primary btn-daftar" disabled={hasAgreed} >DAFTAR</button>
            </div>
        </form> 
        </div>
        </>
